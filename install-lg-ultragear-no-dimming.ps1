...
begin {
    ...
    # Logging helpers with color + emojis (approved verb 'Write')
    function Write-InfoMessage([string]$Message) { Write-Host "ℹ️  $Message" -ForegroundColor Cyan }
    function Write-ActionMessage([string]$Message) { Write-Host "⚙️  $Message" -ForegroundColor Yellow }
    function Write-SuccessMessage([string]$Message) { Write-Host "✅ $Message" -ForegroundColor Green }
    function Write-WarnMessage([string]$Message) { Write-Host "⚠️  $Message" -ForegroundColor DarkYellow }
    function Write-NoteMessage([string]$Message) { Write-Host "📝 $Message" -ForegroundColor Gray }
