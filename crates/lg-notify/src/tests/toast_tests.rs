...
#[test]
fn show_reapply_toast_enabled_non_verbose_does_not_panic() {
    show_reapply_toast(true, "Enabled toast", "Best effort path", false);
}

#[test]
fn show_reapply_toast_enabled_verbose_does_not_panic() {
    show_reapply_toast(true, "Enabled toast", "Verbose best effort path", true);
}

#[test]
fn show_toast_native_returns_result_without_panicking() {
    let result = show_toast_native("Native title", "Native body");
